...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '正在航行🚀',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SpaceyGO', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '正在航行🚀', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.spaceygo.ltd/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '正在航行🚀', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'spaceyl@foxmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || '正在航行🚀', // 站点描述，被notion中的页面描述覆盖
